...
TOKEN_KEYWORDS = %i[PACKAGE IMPORT AS DEFAULT IF CONTAINS SOME IN EVERY NOT WITH ELSE TRUE FALSE NULL DATA INPUT].freeze
TOKEN_OPERATORS = %i[ASSIGN EQ NEQ LT LTE GT GTE PLUS MINUS STAR SLASH PERCENT PIPE AMPERSAND UNIFY].freeze
TOKEN_DELIMITERS = %i[LPAREN RPAREN LBRACKET RBRACKET LBRACE RBRACE DOT COMMA SEMICOLON COLON UNDERSCORE].freeze
TOKEN_LITERALS = %i[STRING NUMBER RAW_STRING IDENT].freeze
